...
export const videos = [
  {
    ...
    categoryName: "Action",
    description:
      "In this third installment of the adrenaline-fueled action franchise, super-assassin John Wick (Keanu Reeves) returns with a $14 million price tag on  his head and an army of bounty-hunting killers on his trail. After killing a member of the shadowy international assassin’s guild,the High Table, John Wick is excommunicado, but the world’s mostruthless hit men and women await his every turn.",
  ...
  },
  {
    ...
    description:
      "Po and the Furious Five are back in the hilarious and critically-acclaimed hit film your whole family will love! When Po discovers a secret village fun-loving, clumsy pandas,  he must train them to defeat Kai, a supernatural villain who threatens to destroy Kung Fu.",
